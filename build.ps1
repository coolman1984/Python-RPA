...
& $buildPython -m PyInstaller --noconfirm --clean --windowed --onedir --name SmartOps --add-data 'smartops_desktop/recorder.js;smartops_desktop' --hidden-import win32service --hidden-import win32gui --hidden-import win32con --hidden-import win32clipboard --hidden-import uiautomation --hidden-import PIL.ImageGrab --collect-all pynput --collect-all playwright --copy-metadata PySide6 --copy-metadata PySide6_Essentials --copy-metadata shiboken6 --copy-metadata openpyxl --copy-metadata PyYAML --exclude-module PySide6.QtWebEngineCore --exclude-module PySide6.QtWebEngineWidgets --exclude-module numpy --exclude-module pandas main.py
